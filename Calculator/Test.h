...
int expression_test() {
    ...
    __TEST__
    expression = "b=pi*e/(sin(tan(10)))/(1+-100*1.2/cos(0.12e4));a=b+122;a*10"; // 1218.81632320905
    __TEST__
    expression = "cos(12.34/(111.22*exp(3)))";  // 0.9999847430913299
    __TEST__
    expression = "sin((2+1))";  // 0.1411200080598672
    __TEST__
    expression = "a=1000 ;b=0.341;a/0.1-100/1999*(a*b-111/23*123/0.12*a+b-a+b/(a+b*-123.33e3))"; // 257493.63629029953
    __TEST__
    ...
    __TEST__
    expression = "a=10;0.0001e5*(pow(101*a/10,cos(0.31*pi*199)))-1*cos((2)+2)-max(cos(100),sin(200))/pow(2,cos(20))";  // 133.84679913329174
    __TEST__
    expression = "cos(((((((((((((((19))+10)))))/1000))))*1911*cos(100)))))"; // -0.7869416029408316
    __TEST__
    expression = "cos(2+(((((((((((((((((((((((((((((((((((((((((((sin(1111))))))))+100)))))*2000)))))))))*2)))))))))))))))))))))))"; // 0.16178461176298067
    __TEST__
    expression = "a=10<<2;a+1"; // 41
    __TEST__
    expression = "a=1000;x=a;b=x;b"; // 1000
    __TEST__
    expression = "-1000-log2(pi*e/-max(10,min(-100,-cos(-pi*22*exp(3)))))"; // -nan
    __TEST__
    expression = "a=100;b=-a-100;c=a-2*b/a;c";  // 104
    __TEST__
    expression = "1000-pow(100,2)";
    __TEST__
    expression = "-1000+-log2(-pi*e/-max(10,min(-100,-cos(pi*22*exp(3)))))";  // -999.7722630754739
    __TEST__
    expression = "-pi";  // -3.14......
    __TEST__
